...
{
    public static class ObterListaTransporteService
    {

        // Criar URI como parametrival no ambiente e nao utilizar a variavel
        private static string URI = ServiceCommon.SystemUrl;
        //private const string URI = "https://62b47363a36f3a973d34604b.mockapi.io";
        private const string URI_SEND_PARAMETERS = "/api/integracao/coletores/v1/escl034api/ObterListaTransporte";

        // Metodo ObterParametros Totvs
        public static async Task<ResulLocalizItemJson> ObterListaTransporte(string pCodDepos, string pCodLocaliz, bool pSemSaldo)
        {
