...
namespace CollectorQi.Views
{
    ...
    public partial class GerarPedidoTipoMovimento : ContentPage, INotifyPropertyChanged
    {
        ...
        public GerarPedidoTipoMovimento(List<DepositosGuardaMaterialItem> listaDepositosGuardaMaterialItem, string local, string codDepos)
        {
            InitializeComponent();
