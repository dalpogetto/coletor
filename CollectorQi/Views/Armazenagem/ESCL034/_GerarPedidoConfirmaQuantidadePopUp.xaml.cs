...
{
    public partial class GerarPedidoConfirmaQuantidadePopUp : PopupPage
    {
        public Action<string, bool, string> _actConfirmaGuardaMateriais;


        public GerarPedidoConfirmaQuantidadePopUp( string pCodDepos, string pCodLocalizacao, string pCodItem, string pTipoTransacao, string pCodBarras /* int pInventarioId, InventarioItemVO pInventarioItem */ )        
        {
            try
            {
                InitializeComponent();
